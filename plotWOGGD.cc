void plotWOGGD(Int_t layer) {
  const Int_t numData = 4;

  TString filename[numData] = {"CoBo_AsAdX_2014-11-14T22:19:20.root",
                               "CoBo_AsAdX_2014-11-14T05:06:42.root",
                               "CoBo_AsAdX_2014-11-14T04:20:17.root",
                               "CoBo_AsAdX_2014-11-14T01:51:31.root"};
  ...
  hist[1] -> GetYaxis() -> SetTitleOffset(1.7);
  ...
  hist[2] -> Draw("same");
  hist[3] -> SetLineColor(28);
  hist[3] -> Draw("same");

  TLegend *legend = new TLegend(0.2, 0.85, 0.50, 0.60, "Beam Intensity");
  legend -> SetNColumns(2);
  legend -> SetEntrySeparation(0.1);
  legend -> SetColumnSeparation(0.1);
  legend -> SetMargin(0.4);
  legend -> AddEntry(hist[0], "10^{2}", "l");
  legend -> AddEntry(hist[1], "10^{3}", "l");
  legend -> AddEntry(hist[2], "10^{4}", "l");
  legend -> AddEntry(hist[3], "10^{5}", "l");
